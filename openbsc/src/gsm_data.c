				     ...
				     int (*mncc_recv)(struct gsm_network *, int, void *))
{
	...
	net->stats.call.dialled = osmo_counter_alloc("net.call.dialled");
	net->stats.call.alerted = osmo_counter_alloc("net.call.alerted");
	net->stats.call.connected = osmo_counter_alloc("net.call.connected");
